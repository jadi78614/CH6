...
const Checkout = () => {
  ...
  const checkOutHandler = async () => {
    ...
    const result = await axios.post(
      "http://localhost:4002/api/user/order/checkout",
    ...
    const options = {
      ...
      handler: async function (response) {
        ...
        const result = await axios.post(
          "http://localhost:4002/api/user/order/paymentVerification",
          data,
          config
        );
        ...
        <div className="row">
          <div className="col-7">
            <div className="checkout-left-data">
              <h3 className="website-name">Timeless</h3>
              <nav
          ...
          <div className="col-5">
            ...
            <div className="border-bottom py-4">
              <div className="d-flex justify-content-between align-items-center">
                ...
                AUD $ {totalAmount ? totalAmount : "0"}
                </p>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <p className="mb-0 total">Shipping</p>
                <p className="mb-0 total-price">AUD $ 100</p>
              </div>
            </div>
            <div className="d-flex justify-content-between align-items-center border-bootom py-4">
              <h4 className="total">Total</h4>
              <h5 className="total-price">
              AUD $ {totalAmount ? totalAmount + 100 : "0"}
              </h5>
            </div>
          </div>
        </div>
