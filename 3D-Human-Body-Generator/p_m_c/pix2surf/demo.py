...
class Demo():
    ...
    def get_args(self):
        ...
        ap.add_argument("--body_tex", type = str, default = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/images/body_tex/body_tex.jpg')

        self.opt = ap.parse_args()
        assert (int(self.opt.img_id) < 10 and int(self.opt.img_id) >= 0), 'Please enter an img_id between 0 and 4'
        assert (int(self.opt.pose_id) < 10 and int(self.opt.pose_id) >= 0), 'Please enter a pose_id between 0 and 4'

    def get_path(self):
        self.opt.low_mesh = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/meshes/'+ self.opt.low_type + '/lower_{}.obj'.format(self.opt.pose_id)
        self.opt.up_mesh = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/meshes/' + self.opt.low_type + '/upper_{}.obj'.format(self.opt.pose_id)
        self.opt.body_mesh = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/meshes/' + self.opt.low_type + '/body_5.obj'.format(self.opt.pose_id)


        self.opt.img_up_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/images/' + self.opt.low_type + '/shirt{}.jpg'.format(self.opt.img_id)
        self.opt.img_up_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/images/' + self.opt.low_type + '/shirt{}_b.jpg'.format(self.opt.img_id)

        self.opt.img_low_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/images/' + self.opt.low_type + '/{}{}.jpg'.format(self.opt.low_type, self.opt.img_id)
        self.opt.img_low_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/test_data/images/' + self.opt.low_type + '/{}{}_b.jpg'.format(self.opt.low_type, self.opt.img_id)

        self.opt.seg_up_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/seg_shirts_front.pt'
        self.opt.seg_up_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/seg_shirts_back.pt'

        self.opt.map_up_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/map_shirts_front.pt'
        self.opt.map_up_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/map_shirts_back.pt'

        self.opt.seg_low_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/seg_{}.pt'.format(self.opt.low_type)
        self.opt.seg_low_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/seg_{}.pt'.format(self.opt.low_type)

        self.opt.map_low_front = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/map_{}_front.pt'.format(self.opt.low_type)
        self.opt.map_low_back = '/Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/pretrained/map_{}_back.pt'.format(self.opt.low_type)
    ...
    def get_gpus(self):
        ...
        if gpus[0] == -1:
            ...
            self.device = torch.device("cpu", index=gpus[0])
    ...
    def forward(self):
        ...
        for val in dict:
            ...
            self.net_map.load_state_dict(torch.load(map_net_pth, map_location=torch.device('cpu')))

            seg_net_pth = getattr(self.opt, 'seg_'+val)
            self.net_seg.load_state_dict(torch.load(seg_net_pth,map_location=torch.device('cpu')))
    ...
    def run(self):
        ...
        os.system('blender --background --python /Users/phun/Downloads/3D-Human-Body-Generator/p_m_c/pix2surf/render.py -- --body_tex {} --body_mesh {} --up_tex {} --up_mesh {} --low_mesh {} --low_tex {} --renderfolder {}'.format(
...
#         # Specify the output paths for rendering
#         ap.add_argument("--output", type=str, default='./output', help="Location where renderings are stored")
...
#         assert (int(self.opt.pose_id) < 6 and int(self.opt.pose_id) >= 0), 'Please enter a pose_id between 0 and 4'
